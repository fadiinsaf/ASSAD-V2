        ...
        <div class="container-fluid p-4">
            ...
            <section id="update-habitat">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="../Controllers/update_habitat.php" method="post">

                            <input type="hidden" name="id" value="<?= $id?>">

                            <div class="mb-3">
                                <label class="form-label">Habitat Name</label>
                                <input type="text" name="name" value="<?= $habitat["name"] ?>" class="form-control">
                            </div>

                                <div class="mb-3">
                                    <label class="form-label">Zoo Zone</label>
                                    <input type="text" name="zoo_zone" value="<?= $habitat["zoo_zone"] ?>" class="form-control">
                                </div>

                            <div class="mb-3">
                                <label class="form-label">Habitat Description</label>
                                <input type="text" name="description" value="<?= $habitat["description"] ?>" class="form-control">
                            </div>
